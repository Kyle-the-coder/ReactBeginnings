...
// Switch does same as xbox, see XboxView.jsx for comments
...
const SwitchResults = () => {
    ...
    useEffect(() => {
        ...
        let call2 = [];
        let call3 = [];
        axios.get('https://api.rawg.io/api/games?platforms=7&dates=2015-01-01,2023-01-01&page_size=50&page=1&')
            .then(res => {
                call1 = res.data.results

                axios.get('https://api.rawg.io/api/games?platforms=7&dates=2015-01-01,2023-01-01&page_size=50&page=2&')
                    .then(res => {
                        call2 = res.data.results

                        axios.get('https://api.rawg.io/api/games?platforms=7&dates=2015-01-01,2023-01-01&page_size=50&page=3&')
                            .then(res => {
    ...
    return (
        <div className='mainC1'>
            <div className="infoBox">
                <h4 className='px-3 text-white my-0'><strong>Top results for "Nintendo Switch"</strong></h4>
